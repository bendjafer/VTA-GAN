...
from lib.models.basemodel_video import BaseModel_Video
from lib.models.temporal_attention import TemporalAttention, TemporalFeatureFusion
from lib.models.temporal_losses import CombinedTemporalLoss
import pdb


class Ocr_Gan_Video(BaseModel_Video):
    """
    ...
    def __init__(self, opt, data, classes):
        super(Ocr_Gan_Video, self).__init__(opt, data, classes)
          # -- Misc attributes
        self.name = 'ocr_gan_video'
        ...
        # Networks are already created in BaseModel_Video
    ...
    def _update_optimizers_with_temporal_params(self):
        """Update optimizers to include temporal attention parameters"""
        # Collect all parameters for generator (including temporal modules)
    ...
    def forward_g(self):
        ...
        if self.use_temporal_attention:
            ...
            # Use temporal-enhanced features for generation
    ...
    def backward_d(self):
        ...
        # Real loss
        self.err_d_real = self.l_adv(pred_real_flat, real_label_expanded)
