...
def load_video_data_FD(opt, classes):
    ...
    train_ds = VideoSnippetDataset(os.path.join(opt.dataroot, 'train'), transform, num_frames)
    valid_ds = VideoSnippetDataset(os.path.join(opt.dataroot, 'test'), transform, num_frames)
...
def load_video_data_FD_aug(opt, classes):
    ...
    train_ds = VideoSnippetDatasetAug(os.path.join(opt.dataroot, 'train'), transform, transform_aug, num_frames)
    valid_ds = VideoSnippetDatasetAug(os.path.join(opt.dataroot, 'test'), transform, transform_aug, num_frames)
